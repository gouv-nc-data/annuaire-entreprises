                ...
                <div className="flex flex-col justify-start gap-4">
                    ...
                    <ul className="inline-flex items-center gap-1 bg-white p-1 rounded-xl shadow-sm border border-input w-full">
                        <li className="w-full border-r-1 pe-1">
                            ...
                            >
                                <FileX strokeWidth={1.2} className={`${searchParamsSituationEntreprise === 'R' ? 'fill-red-200' : 'text-red-500 fill-red-50'} w-4 h-4 text-red-dinum`} />
                                <span>Fermée</span>
                            </button>
                        </li>
                        <li className="w-full">
                            ...
                            >
                                <FileCheck strokeWidth={1.2} className={`${searchParamsSituationEntreprise === 'I' ? 'fill-blue-200' : 'fill-blue-50'} w-4 h-4 text-blue-dinum `} />
