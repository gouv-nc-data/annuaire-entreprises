...
import SearchFiltersTypeStructure from "./search-filters-type-structure"

export type DataType = {
    [key: string]: string
}

export default function SearchFiltersStructure({ label, icon }: ISearchFilter) {

    const [searchParams] = useSearchParams();
    const [isOpen, setIsOpen] = useState(false)

    const searchParamsFormatted = new SearchParams(searchParams)
    const filtersAreActive = searchParamsFormatted.isStructureFilterActive
